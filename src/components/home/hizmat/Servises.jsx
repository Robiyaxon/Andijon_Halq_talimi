...
export const Service = () => {
  ...
  const map = [
    { id: 1,
      //  img: kitob, 
      // title: t("transbanktitle_r"), 
      p: t("ishtiyoq") },
    {
      id: 2,
      // img: odam,
      // title: t("poliknika_r"),
      p: "Semper integer est quis leo, nunc. Quis lectus amet aenean massa turpis senectus ",
    },
    {
      id: 3,
      // img: naushnik,
      title: t("poliknikaraqami_r"),
      p: "Semper integer est quis leo, nunc. Quis lectus amet aenean massa turpis senectus ",
    },
    {
      id: 5,
      // img: yurak,
      title: t("transbankfiliali_r"),
      p: "Semper integer est quis leo, nunc. Quis lectus amet aenean massa turpis senectus ",
    },
    {
      id: 6,
      // img: soat,
      title: t("filialhaqida_r"),
      p: "Semper integer est quis leo, nunc. Quis lectus amet aenean massa turpis senectus ",
    },
    {
      id: 7,
      // img: yetti,
      title: t("yangilipage_r"),
      p: "Semper integer est quis leo, nunc. Quis lectus amet aenean massa turpis senectus ",
    },
  ];
  const map2 = map.map((a) => (
    <div className={style.card1} key={a.id}>
      {/* <img src={a.img} alt="" /> */}
  ...
  return (
    <div className={style.Service} id="service">
      ...
      <h6>{t("xizmat")}</h6>
      <div className={style.container}>{map2}</div>
    </div>
  );
};
